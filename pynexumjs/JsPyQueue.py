...
def push_nowait(key: str,
    ...
    ----------
    // You need to load 'socket_mennager.js' and 'JsPyQueue.js' in advance.
...
WebSocketManager.add_protocol('queue', _queue)
WebSocketManager.add_protocol('queue_call', _queue)
WebSocketManager.add_protocol('queue_return', _queue_return)
